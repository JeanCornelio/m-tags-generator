    ...
    <>
      <nav className=" fixed md:static border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-slate-900 w-full box-border h-16 flex justify-center ">
        ...
        <ul className="flex gap-3 text-base text-slate-700 font-medium  dark:text-white">
            <li >
              <NavLink to="/generate-page" className={({isActive})=> isActive ?'text-indigo-600' : ' hover:text-indigo-600'}>
              Generate
              </NavLink>
              </li>
            <li>
              <NavLink to="/preview-page" className={({isActive})=> isActive ?'text-indigo-600' : 'hover:text-indigo-600'}>
              Preview
              </NavLink>
              </li>
          </ul>
